require_relative '../models/address_book'
 ...
 RSpec.describe AddressBook do
   ...
   # Test that AddressBook's .import_from_csv() method is working as expected
    ...
    describe "importing from second entries file" do
      ...
      it "imports 1st entry" do
        book.import_from_csv("entries_2.csv")
        entry_one = book.entries[0]
        check_entry(entry_one, "Ayla", "555-555-4444", "ayla@email.com")
     end

     it "imports 2nd entry" do
       book.import_from_csv("entries_2.csv")
       entry_two = book.entries[1]
       check_entry(entry_two, "Evan", "555-555-5555", "evan@email.com")
     end

      it "imports 3rd entry" do
        book.import_from_csv("entries_2.csv")
        entry_three = book.entries[2]
        check_entry(entry_three, "Porter", "555-555-3333", "porter@email.com")
      end
